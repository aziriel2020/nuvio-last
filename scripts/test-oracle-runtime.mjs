...
try {
  ...
  if (healthBody.ok !== true || healthBody.collectionCount !== 49) {
  ...
  if (!Array.isArray(collectionBody) || collectionBody.length !== 49) {
    throw new Error('Oracle runtime did not preserve the 49 combined collections');
  }
